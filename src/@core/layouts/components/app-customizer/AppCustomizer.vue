  ...
  >
    ...
    <div class="customizer-section d-flex justify-content-between align-items-center">
      <div>
        ...
        <small>شخصی سازی و اعمال روی قالب در لحظه</small>
      </div>
      <feather-icon
        icon="XIcon"
        size="18"
    ...
    >
      ...
      <div class="customizer-section">
        ...
        >
          <span class="font-weight-bold">کوچک کردن منو</span>
          <b-form-checkbox
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
          <span class="font-weight-bold">مخفی کردن</span>
          <b-form-checkbox
      ...
      <div class="customizer-section">
        ...
        <!-- Navbar Type -->
        <b-form-group :label="layoutType === 'vertical' ? 'حالت منو بالایی' : 'حالت منو'">
          <b-form-radio-group
            v-model="navbarType"
            name="navbar-type"
            :options="navbarTypes"
      ...
      <div class="customizer-section">
        ...
        <!-- Footer Type -->
        <b-form-group label="حالت پاورقی">
          <b-form-radio-group
            v-model="footerType"
            name="footer-type"
            :options="footerTypes"
